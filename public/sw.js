...
self.addEventListener("fetch", event => {
  ...
  if (event.request.method !== "GET" || !["http:", "https:"].includes(url.protocol) || !url.pathname.startsWith(BASE_PATH) || url.pathname.startsWith(`${BASE_PATH}api/`) || event.request.mode === "navigate") return;
